module.exports = colors => {
    ...
    return `
        ...
        featuredStickers_buttonText=#${colors[0]}
        featuredStickers_addedIcon=#ff${colors[1]}
        featuredStickers_addButton=#${colors[1]}
        featuredStickers_addButtonPressed=#${colors[2]}
        ...
        checkbox=#ff${colors[0]}
        checkboxCheck=#ff${colors[1]}
        checkboxSquareBackground=#ff${colors[0]}
        checkboxSquareCheck=#ff${colors[1]}
        ...
        chat_emojiSearchBackground=${colors[1]}
